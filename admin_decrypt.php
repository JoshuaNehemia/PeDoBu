...
<div class="sidebar">
    ...
    <div class="middle-section">
        ...
        <button onclick="location.href='admin_decrypt.php'"><img src="assets/images/LogoKeyBold.png" alt="Decrypt"></button>
    </div>
        ...
        <div class="decrypt-container">
            ...
            <form class="decrypt-form" method = "POST" action = "admin_decrypt_process.php">
                <div class="form-group">
                    ...
                    <textarea id="ciphertext" class="form-control" rows="4" placeholder="Enter encrypted message"></textarea>
                </div>
                
                <div class="form-group">
                    <label for="key">Key <span>*</span></label>
                    <input type="text" id="key" class="form-control" placeholder="Enter decryption key">
                </div>
