...
if(OrderDAO::Select_Available_Orders())
{

    $userOrder = OrderDAO::Select_Available_Orders();
    ...
    $_SESSION['orderdrivermaunerimajangandipakaiini']=$userOrder->getId();
...
<head>
    ...
    <style>
        body {
            ...
            display: flex;
            /* Untuk tata letak sidebar dan konten */
            min-height: 100vh;
        }
        ...
        .sidebar {
            ...
            /* Latar belakang sidebar terang */
            width: 60px;
            /* Lebar sidebar yang lebih kecil */
            padding: 20px 10px;
            /* Padding vertikal dan horizontal */
            display: flex;
            flex-direction: column;
            align-items: center;
            /* Membuat ikon di tengah horizontal */
            justify-content: space-between;
            /* Distribusi ruang antara item */
            gap: 20px;
            /* Jarak antar ikon (akan terpengaruh oleh justify-content) */
        }
        ...
        .sidebar-icon {
            ...
            height: 30px;
            cursor: pointer;
            /* Memberikan efek hover seperti tombol */
            color: #28a745;
            /* Warna ikon hijau (sesuaikan) */
        ...
        .fee-item {
            display: flex;
            /* Mengatur label dan input menjadi baris */
            flex-direction: column;
        }
...
<body>
    <nav class="sidebar">
        ...
        <div class="tengahPlis">
            ...
            <button onclick="location.href='driver_history.php'"><img src="assets/images/LogoHistory.png" alt="Box"
                    class="sidebar-icon">
                <button onclick="location.href='driver_profile.php'"><img src="assets/images/LogoProfile.png"
                        alt="Person" class="sidebar-icon">
        </div>
        <button onclick="location.href='driverLogin.php'"><img src="assets/images/LogoLogOut.png" alt="Logout"
                class="sidebar-icon logout-icon"></button>
    </nav>
    <main class="content">
        ...
        <div class="Information-wrap">
            ...
            <div class="payment-info">
                ...
                <div class="fee-item">
                    ...
                    <input type="text" id="fee" value=<?php echo "Rp." . $price; ?> readonly>
                </div>
            </div>
            <div class="map-buttons">
                <form action="driver_acceptOrder.php" method="POST">
                    <p>Terima order?</p>
                    <?php ?>
                    <input type="submit" class="accept-button">
                </form>
    ...
    <div id="map-container">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.391171237742!2d112.782338!3d-7.311205!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fbd0b2d125ab%3A0xc8534b0a3b89a715!2sJl.%20Kedinding%20Lor%20II%20No%205%2C%20Surabaya!5e0!3m2!1sen!2sid!4v1712717740000!5m2!1sen!2sid"
            allowfullscreen>
        </iframe>
    </div>
    </div>
