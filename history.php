...
require_once __DIR__ . '/library/DAO/HistoryDAO.php';

use App\Database\HistoryDAO;
...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="bottom-section">
      <button onclick="location.href='profile.php'"><img src="assets/images/LogoLogOut.png" alt="Logout"></button>
    </div>
  </div>
  ...
  <div class="content">
    ...
    $orders = HistoryDAO::Select_Orders_By_Users_Username($_SESSION['user']['username']);
    foreach($orders as $key => $order_id)
    {
      $id=$order_id;
      include('history-card.php');
    }
    ?>
  </div>
</body>
